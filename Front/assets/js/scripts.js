...
function addItem(id, name, image, goingCount, isGoing){
   $( ".result" ).append(
                "<li class='list-group-item'>" + "<div class='row'><img class='img-fluid img-thumbnail rounded float-left' style='width:30px;height:30px;' src='" + image + "'>" + name +  + isGoing + goingCount + "</div></li>"
            );
}